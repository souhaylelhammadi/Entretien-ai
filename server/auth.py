...
def register():
    ...
    try:
        ...
        current_app.logger.error(f"Erreur d'enregistrement : {str(e)}")
...
def login():
    ...
    try:
        ...
        current_app.logger.error(f"Erreur de connexion : {str(e)}")
...
def get_profile():
    ...
    try:
        ...
        current_app.logger.error(f"Erreur de profil : {str(e)}")
        return jsonify({"message": "Erreur serveur lors de la récupération du profil"}), 500
...
def logout():
    ...
    try:
        ...
        current_app.logger.error(f"Erreur de déconnexion : {str(e)}")
