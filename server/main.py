...
# Configuration de MongoDB via Flask-PyMongo
app.config["MONGO_URI"] = os.getenv("MONGODB_URI", "mongodb://localhost:27017/recruitment_db")
mongo = PyMongo(app)
...
# --- Route pour les enregistrements d'entretiens ---
...
def save_recording():
    try:
        ...
        # Mettre à jour la collection accepted_offers
